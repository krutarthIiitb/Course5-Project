...
public class AnswerDAO {
    ...
    public AnswerEntity updateQuestion(AnswerEntity answerEntity) {
    ...
    public List<AnswerEntity> getAllAnswerByQuestion(String uuid) {
        return entityManager.createNamedQuery("getAllAnswerByQuestion", AnswerEntity.class).setParameter("uuid", uuid).getResultList();
    }
}
